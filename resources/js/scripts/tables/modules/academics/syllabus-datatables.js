const SyllabusDatatable = (function () {
    'use strict';
    ...
    function initializeTable() {
        ...
        table.DataTable(
            Application.getDatatableConfiguration(SyllabusDatatable)
        )
    }
    ...
    function initializeEvents() {
        ...
        $('.createEntry').on('click', function () {
            SyllabusDatatable.getRegisterForm().then(function () {
        ...
        $('#dataTable tbody').on('click', '.delete-record',  function (event) {
            ...
            Delete.run(SyllabusDatatable, dataId, table, row);
        });
    }
    ...
    function createForm(modal) {
        ...
        modal.find('[id="okModal"]').on('click', function () {
            ...
            SyllabusDatatable.save({
                ...
                // Reload table
                SyllabusDatatable.getList().then(function () {
