const UniqueExamReceiptsEvents = (function () {
    'use strict';
    ...
    function initializeTable() {
        ...
        table.DataTable(
            Application.getDatatableConfiguration(
                UniqueExamReceiptsEvents, UniqueExamReceiptsDatatable()
            ))
    ...
    function initializeEvents() {
        ...
        $('.createEntry').on('click', function () {
            UniqueExamReceiptsEvents.getRegisterForm().then(function () {
        ...
        $('#dataTable tbody').on('click', '.item-show', function (event) {
            ...
            UniqueExamReceiptsEvents.getShowForm(
                itemId
            ).then(function () {
                let modal = Modal.create({
                    id: 'showData'
        ...
        $('#dataTable tbody').on('click', '.item-edit', function (event) {
            ...
            UniqueExamReceiptsEvents.getEditForm(
                itemId
            ).then(function () {
                let modal = Modal.create({
                    id: 'editForm'
        ...
        $('#dataTable tbody').on('click', '.delete-record', function (event) {
            ...
            Delete.run(UniqueExamReceiptsEvents, dataId, table, row);
        });
    ...
    function createForm(modal) {
        ...
        modal.find('[id="okModal"]').on('click', function () {
            ...
            UniqueExamReceiptsEvents.save({
                ...
                rubric: form.find('input[id="selected_rubric"]').val(),
    ...
    function updateForm(modal) {
        ...
        modal.find('[id="okModal"]').on('click', function () {
            ...
            UniqueExamReceiptsEvents.update({
                _token: Application.getToken(),
