...
$(function () {
    ...
    if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
            ...
            serverSide: true,
            ajax: ({
                url: window.location.origin + '/api/email_settings',
                type: 'GET',
            }),
        ...
        $('div.head-label').html('<h6 class="mb-0">Configuración correos</h6>');
    }
    ...
    $('.data-submit').on('click', function () {
        const $school_id = $('.add-new-record .dt-school-id').val(),
            $email_protocol = $('.add-new-record .dt-protocol').val(),
            $smtp_host = $('.add-new-record .dt-smtp-host').val(),
            $smtp_port = $('.add-new-record .dt-smtp-port').val(),
            $smtp_username = $('.add-new-record .dt-smtp-username').val(),
            $smtp_password = $('.add-new-record .dt-smtp-password').val(),
            $smtp_security = $('.add-new-record .dt-smtp-security').val(),
            $smtp_timeout = $('.add-new-record .dt-smtp-timeout').val(),
            $email_type = $('.add-new-record .dt-email-type').val(),
            $email_charset = $('.add-new-record .dt-email-charset').val(),
            $email_priority = $('.add-new-record .dt-email-priority').val(),
            $email_person_name = $('.add-new-record .dt-email-person-name').val(),
            $email_address = $('.add-new-record .dt-email-address').val();
        ...
        if ($email_protocol !== '' && $smtp_host !== '' && $smtp_port !== '' && $smtp_username !== ''  && $smtp_password !== '') {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#basic-icon-default-email_settings').val('');
