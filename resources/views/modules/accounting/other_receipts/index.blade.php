            ...
            <div class="card-body">
                <div class="row">
                    <div class="table-responsive">
                        @include('modules.accounting.other_receipts.list.other-receipt-list')
                    </div>
                </div>
            </div>
        </div>
...
@section('page-script')
    ...
    <script src="{{ asset(mix('data/datatables/other-receipts/other-receipts-datatable.js')) }}"></script>
    <script
        src="{{ asset(mix('js/scripts/tables/modules/accounting/other-receipts-events.js')) }}"
        onload="OtherReceiptsEvents.load()">
    </script>
    <!-- Datatable config, events and data -->
