...
@section('title', 'Administración de recibos de examen único')
            ...
            <div class="card-body">
                <div class="row">
                    <div class="table-responsive">
                        @include('modules.accounting.unique_exam_receipts.list.unique-exam-receipt-list')
                    </div>
                </div>
            </div>
        </div>
...
@section('page-script')
    ...
    <script src="{{ asset(mix('js/scripts/forms/validation/other-receipt-validation.js')) }}"></script>
    <!-- Datatable config, events and data -->
    <script src="{{ asset(mix('data/datatables/unique-exam-receipts/unique-exam-receipts-datatable.js')) }}"></script>
    <script
        src="{{ asset(mix('js/scripts/tables/modules/accounting/unique-exam-receipts-events.js')) }}"
        onload="UniqueExamReceiptsEvents.load()">
    </script>
    <!-- Datatable config, events and data -->
