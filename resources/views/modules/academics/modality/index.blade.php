...
@section('title', 'Administrar modalidades')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="divAgreementTable" class="table-responsive">
                                    @include('modules.academics.modality.list.list')
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('page-script')
    ...
    {{-- Local JS files --}}
    <script src="{{ asset(mix('js/scripts/tables/modules/academics/modality-datatables.js')) }}"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            ModalityDatatable.load();
        });
    </script>
