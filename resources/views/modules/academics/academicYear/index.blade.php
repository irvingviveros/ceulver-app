...
@section('title', 'Administrar generaciones')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="divAgreementTable" class="table-responsive">
                                    @include('modules.academics.academicYear.list.list')
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('page-script')
    ...
    {{-- Local JS files --}}
    <script src="{{ asset(mix('js/scripts/tables/modules/academics/academicYear-datatables.js')) }}"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            AcademicYearDatatable.load();
        });
    </script>
