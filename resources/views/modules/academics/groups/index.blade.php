...
@section('title', 'Administración de grupos')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="divAgreementTable" class="table-responsive">
                                    @include('modules.academics.groups.list.list')
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('page-script')
    ...
    {{-- Local JS files --}}
    <script src="{{ asset(mix('js/scripts/tables/modules/academics/group-datatables.js')) }}"></script>
